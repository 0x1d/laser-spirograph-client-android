...
public class AndLaser extends Activity {
...
//    };
    ...
    int currentPresetNbr = 0;
    
    public void processMotorValue(int motorNr, int value){
    	
    	// set UI texts
    	((Button)findViewById(R.id.Reset)).setText(progressM1+" | "+progressM2+" | "+progressM3+" | "+progressLaser);

    	TextView cmdTF = (TextView) findViewById(R.id.EditText01);
    	String spinnerValue = (String) ((Spinner) findViewById(R.id.Spinner01)).getSelectedItem();
    	/*
    	if(spinnerValue.equals("SPV")){
    		cmdTF.setText(currentPresetNbr+" "+progressM1+" "+progressM2+" "+progressM3+" "+progressLaser);	
    	}
		*/
		// send value to bluetooth
		String str = "AT SMS "+motorNr+" "+(value +1)+"\r";
...
//  motor speed 1 seekbar
        final SeekBar m1 = (SeekBar) findViewById(R.id.MotorSeekBar01);
        m1.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			public void onProgressChanged(SeekBar seekBar, int progress,
				...
				progressM1 = progress;
				processMotorValue(1, progress);
				
			}
		});
        
 //  motor speed 2 seekbar        
        final SeekBar m2 = (SeekBar) findViewById(R.id.MotorSeekBar02);
        m2.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			public void onProgressChanged(SeekBar seekBar, int progress,
				...
				progressM2 = progress;
				processMotorValue(2, progress);
				
			}
		});
//  motor speed 3 seekbar        
        final SeekBar m3 = (SeekBar) findViewById(R.id.MotorSeekBar03);
        m3.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			public void onProgressChanged(SeekBar seekBar, int progress,
				...
				progressM3 = progress;
				processMotorValue(3, progress);
				
			}
		});
        
//  lase speed seekbar        
        final SeekBar lsr = (SeekBar) findViewById(R.id.SeekBar01);
        lsr.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			public void onProgressChanged(SeekBar seekBar, int progress,
				...
				progressLaser = progress;
				resetBtn.setText(progressM1+" | "+progressM2+" | "+progressM3+" | "+progressLaser);
		    	/*
				String spinnerValue = (String) ((Spinner) findViewById(R.id.Spinner01)).getSelectedItem();
		    	
		    	if(spinnerValue.equals("SPV")){
		    		((TextView) findViewById(R.id.EditText01)).setText(currentPresetNbr+" "+progressM1+" "+progressM2+" "+progressM3+" "+progressLaser);	
		    	}
				*/
				//((TextView) findViewById(R.id.EditText01)).setText(progressM1+" "+progressM2+" "+progressM3+" "+progressLaser);
				
				String str = "AT SLV "+(progress +1)+"\r";
				mSerialService.write( str.getBytes() );
...
// reset button
        resetBtn.setOnClickListener(new OnClickListener() {
	        ...
	        public void onClick(View arg0) {
	        	...
	        	m1.setProgress(progressM1);
	        	m2.setProgress(progressM2);
	        	m3.setProgress(progressM3);
	        	lsr.setProgress(progressLaser);
	        	
	        	resetBtn.setText(progressM1+" | "+progressM2+" | "+progressM3+" | "+progressLaser);
	        	
	        	processMotorValue(1, 0);
	        	processMotorValue(2, 0);
	        	processMotorValue(3, 0);
				mSerialService.write( ("AT SLV 1\r").getBytes() );
	        }
        });
...
// modes spinner
        String[] items = new String[] { 
        		"CMD", // command
        		"SPV", // set preset value
        		"LPN", // load preset number
        		"RPM", // run preset mode
        		"SPM", // stop preset mode
        		"SDL"  // set debug level
        };
        ...
        new  AdapterView.OnItemSelectedListener() {           
		   ...
		   public void onItemSelected(AdapterView<?> parent, 
		     View view, int position, long id) {
			   TextView tf = ((TextView) findViewById(R.id.EditText01)); 
			   ((TextView) findViewById(R.id.EditText01)).setText("");
			   
			   if(spinner.getSelectedItem().equals("RPM")){
				   tf.setText("1 5");
				   ((Button) findViewById(R.id.Send)).setText("Run");
		    	} else if(spinner.getSelectedItem().equals("SPM")){
		    		tf.setText("");
		    		((Button) findViewById(R.id.Send)).setText("Stop");
		    	}else if(spinner.getSelectedItem().equals("SPV")){
		    		tf.setText(String.valueOf(currentPresetNbr));
		    		((Button) findViewById(R.id.Send)).setText("Save");
		    	} 
		    	else if(spinner.getSelectedItem().equals("LPN")){
		    		tf.setText(String.valueOf(currentPresetNbr));
		    		((Button) findViewById(R.id.Send)).setText("Load");
		    	} else {
		    		((Button) findViewById(R.id.Send)).setText("Send");
		    	}
...
// preset button +
        ...
        final Button nextPresetButton = (Button) findViewById(R.id.NextPresetButton);
        nextPresetButton.setOnClickListener(new OnClickListener() {

	        public void onClick(View arg0) {
	        	currentPresetNbr++;
	        	if(currentPresetNbr <= 200){
		        	spinner.setSelection(1);
		        	((TextView) findViewById(R.id.EditText01)).setText(String.valueOf(currentPresetNbr));
					mSerialService.write( ("AT LPN "+String.valueOf(currentPresetNbr)+"\r").getBytes() );
	        	} else {
	        		currentPresetNbr = 1;
	        	}
...
// preset button +
        final Button lastPresetButton = (Button) findViewById(R.id.LastPresetButton);
        lastPresetButton.setOnClickListener(new OnClickListener() {

	        public void onClick(View arg0) {
	        	currentPresetNbr--;
	        	if(currentPresetNbr > 0){
		        	spinner.setSelection(1);
		        	((TextView) findViewById(R.id.EditText01)).setText(String.valueOf(currentPresetNbr));
					mSerialService.write( ("AT LPN "+String.valueOf(currentPresetNbr)+"\r").getBytes() );
	        	} else {
...
// send button
        ...
        sendBtn.setOnClickListener(new OnClickListener() {
	        ...
	        public void onClick(View arg0) {
	        	String str = "";
	        	if(spinner.getSelectedItem().equals("SPV")){
	        		str = "AT SPV "+String.valueOf(currentPresetNbr)+" "+(progressM1+1)+" "+(progressM2+1)+" "+(progressM3+1)+" "+(progressLaser+1)+"\r";
	        	} else if(spinner.getSelectedItem().equals("RPM")) {
	        		str = "AT RPM "+((TextView) findViewById(R.id.EditText01)).getText()+"\r";
						
	        	} else if(spinner.getSelectedItem().equals("SPM")) {
	        		str = "AT SPM\r";
						
	        	} else {
	        		str = "AT "+((TextView) findViewById(R.id.EditText01)).getText()+"\r";
	        	}
	        	mSerialService.write( str.getBytes() );
...
class TerminalEmulator {
    ...
    public void append(byte[] buffer, int base, int length) {
        for (int i = 0; i < length; i++) {
            ...
            try {
                if (AndLaser.LOG_CHARACTERS_FLAG) {
                    char printableB = (char) b;
                    if (b < 32 || b > 126) {
                        printableB = ' ';
                    }
                    Log.w(AndLaser.LOG_TAG, "'" + Character.toString(printableB)
                            + "' (" + Integer.toString(b) + ")");
                }
                process(b);
                mProcessedCharCount++;
            } catch (Exception e) {
                Log.e(AndLaser.LOG_TAG, "Exception while processing character "
    ...
    private void selectGraphicRendition() {
        for (int i = 0; i <= mArgIndex; i++) {
            ...
            if (code == 0) { // reset
                ...
                if (AndLaser.LOG_UNKNOWN_ESCAPE_SEQUENCES) {
                    Log.w(AndLaser.LOG_TAG, String.format("SGR unknown code %d", code));
                }
            }
        }
    }
...
*/
     ...
     */
    public void initialize(AndLaser blueTerm) {
    	mBlueTerm = blueTerm;
        mTextSize = 15;
        mForeground = AndLaser.WHITE;
        mBackground = AndLaser.BLACK;
        updateText();
    ...
    private void updateSize(int w, int h) {
        ...
        if (mTranscriptScreen != null) {
        	...
        	Log.d("BlueTerm", "instantiating Emulator");
            mTranscriptScreen = new TranscriptScreen(mColumns, TRANSCRIPT_ROWS, mRows, 0, 7);
            mEmulator = new TerminalEmulator(mTranscriptScreen, mColumns, mRows);
        }
